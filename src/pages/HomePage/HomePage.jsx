    ...
    return(
        <div className='row'>
            ...
            <div className='column'>
                ...
                <img src="https://i.imgur.com/p74Ib0Bl.jpg" alt="Kendrick Lamar" height='400px' width='500px'/>
            </div>
            <div className="column">
                <img src="https://i.imgur.com/6Cn0f0r.jpg" alt="Schoolboy Q" height='400px' width='600px'/>
